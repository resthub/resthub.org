...
**Solution** : you can find solution at `<http://resthub.org/2/training/spring/solution.html#step-1-initialization>`_
...
**Solution** : you can find solution at `<http://resthub.org/2/training/spring/solution.html#step-2-customize-model>`_
...
**Solution** : you can find solution at `<http://resthub.org/2/training/spring/solution#step-3-customize-controller>`_
...
**Solution** : you can find solution at `<http://resthub.org/2/training/spring/solution#step-4-users-own-tasks>`_
...
**Solution** : you can find solution at `<http://resthub.org/2/training/spring/solution#step-5-validate-your-beans-and-embed-entities>`_
